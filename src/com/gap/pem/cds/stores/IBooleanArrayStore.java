...
public interface IBooleanArrayStore extends IDataStore{
	/**
     ...
     */
    boolean isEmptyValue(Boolean[] value);
     ...
     */
    Boolean[] setElementAt(int index, Boolean[] value);
}
