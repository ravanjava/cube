...
public interface IFloatArrayStore extends IDataStore 
{
	/**
     ...
     */
    boolean isEmptyValue(float[] value);
     ...
     * is added at the end to the given index. The returned value will be 
     * the empty value.</li>
     ...
     */
    float[] setElementAt(int index, float[] value);
}
